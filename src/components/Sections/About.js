    ...
    <StyledAboutSection id="about">
      ...
      <div>
        ...
        <div>
          ...
          <p>
            I enjoy solving problems. Whether it's a simple problem like <a href="https://thumbs.gfycat.com/SeveralEnragedIndigobunting-mobile.mp4">fixing a lightbulb</a> or solving a complex problem like <Link to='/404'>my social life</Link>, I love the challenge. 
          </p>
          <p>
            Before coding, I was pursuing a career in medicine. After realizing how much of today's modern medicine and patient care relies on tech, I soon found myself immersed in learning how to code at <a href="https://flatironschool.com/">The Flatiron School</a>. After graduating, I continue to learn and utilize my skills to solve all sorts of problems through tech.
          </p>
          <p>
